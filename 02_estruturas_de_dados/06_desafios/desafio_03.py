...
def contar_caracteres(string):
    contador = dict()  # dicionário vazio

    for caractere in string:  # iterar pela string
        if caractere in contador:  # já está no dicionário?
            contador[caractere] +=1  # incrementa em 1
        else:
            contador[caractere] = 1  # começa do zero... ou do um?
